...
namespace MPXJ.Net
{
    public class Resource : AbstractFieldContainer, IProjectEntityWithID, IChildResourceContainer, IJavaObjectProxy<org.mpxj.Resource>
    {
        ...
        {
            get => JavaObject.getCurrencyUniqueID().ConvertType();
            set => JavaObject.setCurrencyUniqueID(value.ConvertType());
        }

        public Currency Currency
        {
            get => _proxyManager.ProxyObject(JavaObject.getCurrency());
        ...
        public Duration PlannedWork => _proxyManager.ProxyObject(JavaObject.getPlannedWork());
