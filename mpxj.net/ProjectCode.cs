...
namespace MPXJ.Net
{
    public class ProjectCode : ICode, IJavaObjectProxy<net.sf.mpxj.ProjectCode>
    {
        private readonly ProxyManager _proxyManager;
        public net.sf.mpxj.ProjectCode JavaObject { get; }

        internal ProjectCode(ProxyManager proxyManager, net.sf.mpxj.ProjectCode javaObject)
        {
        ...
        public IList<ProjectCodeValue> Values => _proxyManager.ProxyList<net.sf.mpxj.ProjectCodeValue, ProjectCodeValue>(_proxyManager.ProxyObject, value => value.JavaObject, JavaObject.getValues());
        ...
        public class Builder : IJavaObjectProxy<net.sf.mpxj.ProjectCode.Builder>
        {
            private readonly ProxyManager _proxyManager;
            public net.sf.mpxj.ProjectCode.Builder JavaObject { get; }

            public Builder(ProjectFile file)
            {
                _proxyManager = file._proxyManager;
                JavaObject = new net.sf.mpxj.ProjectCode.Builder(file.JavaObject);
            }
