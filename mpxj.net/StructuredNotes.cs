...
namespace MPXJ.Net
{
    public class StructuredNotes : Notes, IJavaObjectProxy<net.sf.mpxj.StructuredNotes>
    {
        ...
        public StructuredNotes(ProjectFile file, int uniqueID, NotesTopic topic, Notes notes) : base(new net.sf.mpxj.StructuredNotes(uniqueID.ConvertType(), topic.JavaObject, notes.JavaObject))
        {
